...
public:
	...
	void SetCameraRotation(Vector2 dMousePos);

	Matrix GetViewMatrix();
	Matrix GetProjectionMatrix();

	Vector3 GetCameraPosition() { return m_cameraPosition; };
	Vector3 GetViewDirection() { return m_viewDir; };
	Vector3 GetViewVertical() { return m_viewVertical; };
	Vector3 GetViewRight() { return m_viewRight; };
